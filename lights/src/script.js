...
const rectAreaLight = new THREE.RectAreaLight(0x4e0aff, 2, 1, 1);
...
spotLight.target.position.z = -1.75;
scene.add(spotLight);
...
window.requestAnimationFrame(() => {
  ...
  rectAreaLightHelper.quarternion.copy(rectAreaLight.quarternion);
